...
class Browser:
    ...
    def is_text_present(self, text: str, wait_time: int | None = None) -> bool: ...
    ...
    def quit(self) -> None: ...
    def is_element_present_by_css(self, css_selector: str, wait_time: int | None = None) -> bool: ...
    def is_element_not_present_by_css(self, css_selector: str, wait_time: int | None = None) -> bool: ...
    def is_element_present_by_xpath(self, xpath: str, wait_time: int | None = None) -> bool: ...
    def is_element_not_present_by_xpath(self, xpath: str, wait_time: int | None = None) -> bool: ...
    def is_element_present_by_tag(self, tag: str, wait_time: int | None = None) -> bool: ...
    def is_element_not_present_by_tag(self, tag: str, wait_time: int | None = None) -> bool: ...
    def is_element_present_by_name(self, name: str, wait_time: int | None = None) -> bool: ...
    def is_element_not_present_by_name(self, name: str, wait_time: int | None = None) -> bool: ...
    def is_element_present_by_value(self, value: str, wait_time: int | None = None) -> bool: ...
    def is_element_not_present_by_value(self, value: str, wait_time: int | None = None) -> bool: ...
    def is_element_present_by_text(self, text: str, wait_time: int | None = None) -> bool: ...
    def is_element_not_present_by_text(self, text: str, wait_time: int | None = None) -> bool: ...
    def is_element_present_by_id(self, id: str, wait_time: int | None = None) -> bool: ...
    def is_element_not_present_by_id(self, id: str, wait_time: int | None = None) -> bool: ...
    def screenshot(
        self,
        name: str | None = None,
...
class ElementAPI(Protocol):
    ...
    def is_visible(self, wait_time: int | None = None) -> bool: ...
    def is_not_visible(self, wait_time: int | None = None) -> bool: ...
