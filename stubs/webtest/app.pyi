...
class TestApp(Generic[_ResponseT, _AppT]):
    ...
    def request(self, url_or_req: str | TestRequest, status: int | str | None = None, expect_errors: bool = False, **req_params: Any) -> _ResponseT: ...
    def do_request(self, req: TestRequest, status: int | str | None = None, expect_errors: bool | None = None) -> _ResponseT: ...
