...
class Request(BaseRequest):
    ...
    def link_prefix(self, app: App | None = None): ...
    def view(self, obj: object, default: _T | None = None, app: App | Sentinel = ..., **predicates: Any) -> Any | _T | None: ...
    @overload
    def link(self, obj: None, name: str = '', default: None = None, app: App | Sentinel = ...) -> None: ...  # type:ignore[overload-overlap]
    @overload
    ...
    def class_link(self, model: type, variables: dict[str, Any] | None = None, name: str = '', app: App | Sentinel = ...): ...
