...
from onegov.form.core import FieldDependency, Pricing
...
class Field:
    ...
    def process(self, formdata: _MultiDictLikeWithGetlist | None, data: Any = ..., extra_filters: Sequence[_Filter] | None = None) -> None: ...
