...
class ListWidget:
    ...
    prefix_label: bool
    def __init__(self, html_tag: Literal["ul", "ol"] = "ul", prefix_label: bool = True) -> None: ...    # any iterable field is fine, since people might define iterable fields
...
class NumberInput(Input):
    ...
    def __init__(self, step: Decimal | float | str | None = None, min: Decimal | float | str | None = None, max: Decimal | float | str | None = None) -> None: ...
