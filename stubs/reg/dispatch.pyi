...
class _KeyLookup:
    def component(self, __key: Sequence[Any]) -> Callable | None: ...
    def fallback(self, __key: Sequence[Any]) -> Callable | None: ...
    def all(self, __key: Sequence[Any]) -> Iterator[Callable]: ...

class dispatch:
    predicates: list[Predicate]
    get_key_lookup: _GetKeyLookup
    def __init__(self, *predicates: str | Predicate, get_key_lookup: _GetKeyLookup = ...) -> None: ...
    def __call__(self, callable: Callable[_P, _T]) -> Dispatch[_P, _T]: ...
