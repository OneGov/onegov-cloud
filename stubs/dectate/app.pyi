...
class _DirectiveMethod(classmethod[_AppT, _P, Directive]):
    action_factory: type[Action | Composite]
    @overload
    def __get__(self, __instance: _AppT, __owner: type[_AppT] | None = None, /) -> _DirectiveCallable[_P]: ...
    @overload
    def __get__(self, __instance: None, __owner: type[_AppT], /) -> _DirectiveCallable[_P]: ...
