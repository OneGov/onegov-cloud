...
.. image:: https://travis-ci.org/seantis/onegov.user.png
  :target: https://travis-ci.org/seantis/onegov.user
  :alt: Build Status

Coverage
--------

.. image:: https://coveralls.io/repos/seantis/onegov.user/badge.png?branch=master
  :target: https://coveralls.io/r/seantis/onegov.user?branch=master
