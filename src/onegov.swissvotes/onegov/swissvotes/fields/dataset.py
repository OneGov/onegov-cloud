...
COLUMNS = OrderedDict((
    ...
    ('_recommendation_sav', 'p-sav'),
    ('_recommendation_eco', 'p-eco'),
    ('_recommendation_sgv', 'p-sgv'),
    ('_recommendation_sbv_usp', 'p-sbv'),
    ('_recommendation_sgb', 'p-sgb'),
    ('_recommendation_travs', 'p-travs'),
    ('_recommendation_vsa', 'p-vsa'),
    ('_recommendation_vpod', 'p-vpod'),
    ('_recommendation_ssv', 'p-ssv'),
    ('_recommendation_gem', 'p-gem'),
    ('_recommendation_kdk', 'p-kdk'),
    ('_recommendation_vdk', 'p-vdk'),
    ('_recommendation_endk', 'p-endk'),
    ('_recommendation_fdk', 'p-fdk'),
    ('_recommendation_edk', 'p-edk'),
    ('_recommendation_gdk', 'p-gdk'),
    ('_recommendation_ldk', 'p-ldk'),
    ('_recommendation_sodk', 'p-sodk'),
    ('_recommendation_kkjpd', 'p-kkjpd'),
    ('_recommendation_bpuk', 'p-bpuk'),
    ('_recommendation_sbk', 'p-sbk'),
    ('_recommendation_acs', 'p-acs'),
    ('_recommendation_tcs', 'p-tcs'),
    ('_recommendation_vcs', 'p-vcs'),
    ('_recommendation_voev', 'p-voev'),
