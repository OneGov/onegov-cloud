...
def town_handle_new_newsletter(self, request, form):
    return handle_new_newsletter(self, request, form)
...
def town_edit_newsletter(self, request, form):
    return edit_newsletter(self, request, form)
...
def town_handle_send_newsletter(self, request, form):
    return handle_send_newsletter(self, request, form)
...
def town_handle_test_newsletter(self, request, form):
    return handle_test_newsletter(self, request, form)


@TownApp.html(model=Newsletter,
             template='mail_newsletter.pt', name='preview', permission=Private)
def town_handle_preview_newsletter(self, request):
    return handle_preview_newsletter(self, request)
