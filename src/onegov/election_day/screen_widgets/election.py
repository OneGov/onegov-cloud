...
if TYPE_CHECKING:
    ...
    from onegov.election_day.models import Election  # ruff:ignore[unused-import]
    from onegov.election_day.models import ProporzElection  # ruff:ignore[unused-import]
