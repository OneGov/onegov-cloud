    ...
    if form.submitted(request):
        ...
        if form.is_new_attendee:
            attendee = attendees.add(
                ...
                address=form.address.data if form.differing_address.data else None,
                zip_code=form.zip_code.data if form.differing_address.data else None,
                place=form.place.data if form.differing_address.data else None,
                political_municipality=form.political_municipality.data if form.differing_address.data else None
            )
        else:
