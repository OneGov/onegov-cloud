...
@freeze_time("2014-01-01 12:00")
def test_get_election_summary(session: Session) -> None:
    ...
    assert expected == get_election_summary(
        result, None, request.link(election)
    )


@freeze_time("2014-01-01 12:00")
def test_get_election_compound_summary(session: Session) -> None:
    archive = ArchivedResultCollection(session)
    request: Any = DummyRequest()
...
@freeze_time("2014-01-01 12:00")
def test_get_vote_summary(session: Session) -> None:
    archive = ArchivedResultCollection(session)
    request: Any = DummyRequest()
...
@freeze_time("2014-01-01 12:00")
def test_get_summary(session: Session) -> None:
    archive = ArchivedResultCollection(session)
    request: Any = DummyRequest()
...
@freeze_time("2014-01-01 12:00")
def test_get_summaries(session: Session) -> None:
    archive = ArchivedResultCollection(session)
    request: Any = DummyRequest()
