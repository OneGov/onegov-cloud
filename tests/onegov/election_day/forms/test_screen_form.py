...
def test_screen_form_populate(election_day_app):
    ...
    assert form.tags_simple_vote.text == (
        ...
        'row\n'
        'title\n'
        'vote-proposal-entities-table\n'
        'vote-proposal-result-bar'
    )
    assert form.tags_complex_vote.text == (
        ...
        'row\n'
        'title\n'
        'vote-counter-proposal-entities-table\n'
        'vote-counter-proposal-result-bar\n'
        'vote-counter-proposal-title\n'
        'vote-proposal-entities-table\n'
        'vote-proposal-result-bar\n'
        'vote-tie-breaker-entities-table\n'
        'vote-tie-breaker-result-bar\n'
        'vote-tie-breaker-title'
    )
    assert form.tags_majorz_election.text == (
        'column\n'
        'counted-entities\n'
        'election-candidates-chart\n'
    ...
    assert form.tags_proporz_election.text == (
        ...
        'election-candidates-chart\n'
        'election-candidates-table\n'
        'election-lists-chart\n'
        'election-lists-table\n'
        'h1\n'
        'h2\n'
        'h3\n'
        'hr\n'
    ...
    assert form.tags_election_compound.text == (
        ...
        'election-compound-lists-chart\n'
        'election-compound-lists-table\n'
        'h1\n'
        'h2\n'
        'h3\n'
        'hr\n'
