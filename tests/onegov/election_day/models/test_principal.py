...
SUPPORTED_YEARS = list(range(2002, 2020 + 1))

SUPPORTED_YEARS_MAP = list(range(2013, 2020 + 1))
SUPPORTED_YEARS_NO_MAP = list(set(SUPPORTED_YEARS) - set(SUPPORTED_YEARS_MAP))

SUPPORTED_YEARS_MAP_SG = list(range(2004, 2020 + 1))
SUPPORTED_YEARS_NO_MAP_SG = list(
    set(SUPPORTED_YEARS) - set(SUPPORTED_YEARS_MAP_SG)
)

SUPPORTED_YEARS_MAP_ZG = list(range(2004, 2020 + 1))
