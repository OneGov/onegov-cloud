...
@pytest.mark.parametrize('address,expected', [
    ('', ('', '', '', '')),
    ('Leimenstrasse 1, 4001 Basel', ('', '', 'Leimenstrasse 1', '4001 Basel')),
    ('Strassburgerallee 12-18, 4055 Basel',
     ('', '', 'Strassburgerallee ' '12-18', '4055 Basel')),
    ('St. Alban-Graben 5, 4010 Basel',
     ('', '', 'St. Alban-Graben 5', '4010 Basel')),
    ('Unterbrüglingen 31, 4142 MünchensteinPostadresse: Postfach, 4001 Basel',
     ('Unterbrüglingen 31', '4142 Münchenstein', 'Postfach', '4001 Basel')),
    ...
    ('Sekretariat, Hörnliallee 70, 4125 Riehen; Postadresse: Rittergasse 4, '
     '' '4001 Basel', ('Sekretariat, Hörnliallee 70', '4125 Riehen',
...
def test_parse_person_address_field(address, expected):
