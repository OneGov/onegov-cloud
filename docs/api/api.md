...
| updated_ge       | filters agencies updated after or date specified (greater equal)   |
...
| updated_le       | filters people updated before or date specified (lower equal)  |
| updated_eq       | filters people updated at date specified (equal)               |
| updated_ge       | filters people updated after or date specified (greater equal) |
