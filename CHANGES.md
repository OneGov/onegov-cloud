...
##### Extends paginated API endpoints with total item and pages counts

`Feature` | [OGC-3478](https://linear.app/onegovcloud/issue/OGC-3478) | [b56df2fb08](https://github.com/onegov/onegov-cloud/commit/b56df2fb08ff45cbb4a6d9575bfe50308fb7bb73)

##### Guards against malformed and incorrect API keys

`Bugfix` | [ONEGOV-CLOUD-5Z4](https://seantis-gmbh.sentry.io/issues/?query=ONEGOV-CLOUD-5Z4) | [7e56d18f5a](https://github.com/onegov/onegov-cloud/commit/7e56d18f5a02bb64e61397610c5ba39260631ad1)

##### Fixes handling of file uploads through JSON API

Previously the JSON path neglected to populate `file` and `filename` on
the corresponding form field, which causes issues on any code path that
tries to access them, rather than relying on the `data` attribute alone.

`Bugfix` | [ONEGOV-CLOUD-5Z9](https://seantis-gmbh.sentry.io/issues/?query=ONEGOV-CLOUD-5Z9) | [85c9f520ba](https://github.com/onegov/onegov-cloud/commit/85c9f520bacec5c42186e2568ee6ac6ac07780ab)

##### Prevents cache roundtrips for custom event tags, request cached now

`Performance` | [ONEGOV-CLOUD-5Z3](https://seantis-gmbh.sentry.io/issues/?query=ONEGOV-CLOUD-5Z3) | [0e3960fc60](https://github.com/onegov/onegov-cloud/commit/0e3960fc605259479efcba11a3897157478064a4)

### Core

##### Add cache report tool for debugging

In analogy to sql_query_report

`Feature` | [NONE](#NONE) | [7d09a4ea43](https://github.com/onegov/onegov-cloud/commit/7d09a4ea43f56f309c880adcb05e537f2e6d761d)

### Directory

##### Fix flaky ordering assertion in entry collection test

`Bugfix` | [NONE](#NONE) | [621df30726](https://github.com/onegov/onegov-cloud/commit/621df30726ad6f6a9151848e5151c9c6cfe9b6de)

### Org

##### Trim display name to be more robust in matching.

`Bugfix` | [OGC-3444](https://linear.app/onegovcloud/issue/OGC-3444) | [5efd8fe8fd](https://github.com/onegov/onegov-cloud/commit/5efd8fe8fdc2cc86802cd9955b92b46a2dc4cdb1)

##### Fixes validators on fields making use of `strip_whitespace`

Previously these fields were relying solely on `InputRequired` for
validation, which only checks the raw input prior to filtering. So we
also need `DataRequired` to make sure the filtered data also is not
empty. Using only `DataRequired` isn't quite right either, since it
may accept edits where the field is missing from the formdata. The
latter is mostly harmless, since it ensures the original data is
retained, but it might still produce surprising results for end users.

`Bugfix` | [ONEGOV-CLOUD-5Z6](https://seantis-gmbh.sentry.io/issues/?query=ONEGOV-CLOUD-5Z6) | [29a2c6548e](https://github.com/onegov/onegov-cloud/commit/29a2c6548e8299f1b986e605517c6f38d3c778ba)

### Pas

##### Restrict bulk add commission attendance view.

`Bugfix` | [NONE](#NONE) | [fc504416c0](https://github.com/onegov/onegov-cloud/commit/fc504416c08728d76cc84efaab72233552f10683)

##### Reduce amount of log calls in import.

`Bugfix` | [b26f8e4398](https://github.com/onegov/onegov-cloud/commit/b26f8e4398919ad7a2b62bbe9a7f857d40a97fee)

### People

##### Fix NoneType for sub organisations

`Bugfix` | [ONEGOV-CLOUD-5Z5](https://seantis-gmbh.sentry.io/issues/?query=ONEGOV-CLOUD-5Z5) | [093b73d513](https://github.com/onegov/onegov-cloud/commit/093b73d51362d3268f76a7fdcfd3a35a5e7a533e)

### Reservation

##### Adds ics subscribe url to email confirmation, add limited summary view via durable magic link (no login)

This replaces the single mtan access in the confirmation email with a durable link to a limited summary view with option to (citizen) login.

`Feature` | [OGC-2313](https://linear.app/onegovcloud/issue/OGC-2313) | [98f9b88820](https://github.com/onegov/onegov-cloud/commit/98f9b888200eeb712cfb2973d16c6338ca17b960)

### Ris

##### Change labels for commission and political group members

`Feature` | [OGC-3461](https://linear.app/onegovcloud/issue/OGC-3461) | [e1e596363c](https://github.com/onegov/onegov-cloud/commit/e1e596363cd430cec4877e4289eb8d35bd8bb2b5)

##### Order members of political groups alphabetically

`Bugfix` | [OGC-3460](https://linear.app/onegovcloud/issue/OGC-3460) | [0d57fd7651](https://github.com/onegov/onegov-cloud/commit/0d57fd7651d07004c50ec913e9ed3cb08c71341b)

##### Fix sidebar label for commissions

`Bugfix` | [OGC-3462](https://linear.app/onegovcloud/issue/OGC-3462) | [fc502e1433](https://github.com/onegov/onegov-cloud/commit/fc502e14337938f0e32ae5d177932419422668ff)

### Town6

##### Show new release notes

`Feature` | [OGC-643](https://linear.app/onegovcloud/issue/OGC-643) | [79676718db](https://github.com/onegov/onegov-cloud/commit/79676718dbdac99f8287f93d50e9cb4afce89572)

## 2026.47

`2026-09-17` | [6bf623e9f7...c597ea5333](https://github.com/OneGov/onegov-cloud/compare/6bf623e9f7^...c597ea5333)

### Api

##### Extends `Collection+JSON` templates with additional metadata

This adds the extra fields `required`, `fieldset`, `depends_on` and
`value_json_schema` to template items, to give more detailed information
on what kind of JSON values these endpoints expect to receive.

`Feature` | [OGC-3410](https://linear.app/onegovcloud/issue/OGC-3410) | [5627d5289e](https://github.com/onegov/onegov-cloud/commit/5627d5289e86e82c879bade3de9d224a2c67905a)

### Core

##### Add audit trail.

`Feature` | [OGC-180](https://linear.app/onegovcloud/issue/OGC-180) | [6bf623e9f7](https://github.com/onegov/onegov-cloud/commit/6bf623e9f75542974cab59c3180c8cdbe3a29cf5)

##### Replace `bleach`, `html2text`, `urlextract` with `turbohtml`

`Performance` | [a099b6270f](https://github.com/onegov/onegov-cloud/commit/a099b6270f00e6481b6f56382423c6aef19391d4)

### Feriennet

##### Fix volunteer bug

`Bugfix` | [PRO-1600](https://linear.app/projuventute/issue/PRO-1600) | [c147bcbeb1](https://github.com/onegov/onegov-cloud/commit/c147bcbeb1dfbb52c700d8b0f9a06b8205fa44ab)

### Org

##### Fixes pasting topics into iframe topics

`Bugfix` | [ONEGOV-CLOUD-5Z0](https://seantis-gmbh.sentry.io/issues/?query=ONEGOV-CLOUD-5Z0) | [f48abd2622](https://github.com/onegov/onegov-cloud/commit/f48abd2622e10e8d4769b470451dac34cff56370)

##### Allow wildcard CSP domains for iFrame URLs

`Bugfix` | [PRO-1583](https://linear.app/projuventute/issue/PRO-1583) | [ed1c89d156](https://github.com/onegov/onegov-cloud/commit/ed1c89d1563927614a00435f367465b9ec065692)

### Pay

##### Makes sure invoice items cannot be orphaned and deletes orphans

`Bugfix` | [ONEGOV-CLOUD-5Z1](https://seantis-gmbh.sentry.io/issues/?query=ONEGOV-CLOUD-5Z1) | [271f4cb329](https://github.com/onegov/onegov-cloud/commit/271f4cb329e26743b67d9f8747f0d53821568675)

### User

##### Adds inline user search

`Feature` | [PRO-1472](https://linear.app/projuventute/issue/PRO-1472) | [34843bb32b](https://github.com/onegov/onegov-cloud/commit/34843bb32b97e3e6511871cedb3f2b98d7ecfbd0)

## 2026.46

`2026-09-15` | [a3d2533914...44eba53408](https://github.com/OneGov/onegov-cloud/compare/a3d2533914^...44eba53408)

### Org

##### Fix some design issues

`Bugfix` | [bce284739a](https://github.com/onegov/onegov-cloud/commit/bce284739a450838c229a47e62d60a0611b63d6c)

### Ticket

##### Fix missing icon message button

`Bugfix` | [NONE](#NONE) | [540c80e981](https://github.com/onegov/onegov-cloud/commit/540c80e981b1e01457e7f98992bdc971f0029a07)

##### Align font size of refund payment and view invoice buttons

`Bugfix` | [NONE](#NONE) | [8e55333a18](https://github.com/onegov/onegov-cloud/commit/8e55333a182c48cbfde1cb6c7bcfa74ea15575d9)

## 2026.45

`2026-09-11` | [fca8cf953e...79364de951](https://github.com/OneGov/onegov-cloud/compare/fca8cf953e^...79364de951)
...
##### Avoids missing type information in table join

`Bugfix` | [ONEGOV-CLOUD-5XY](https://seantis-gmbh.sentry.io/issues/?query=ONEGOV-CLOUD-5XY) | [5aea017a23](https://github.com/onegov/onegov-cloud/commit/5aea017a23a6e5d3ae5ef709df5050101e6ef7ff)

### Core

##### Removes `fs`/`PyFilesystem` dependency
...
`Feature` | [OGC-1607](https://linear.app/onegovcloud/issue/OGC-1607) | [4d7ef8dffe](https://github.com/onegov/onegov-cloud/commit/4d7ef8dffe06cb4a4342d517012a0f71a1e8bb6a)

##### Removes remaining dependencies on `pkg_resources`

`Feature` | [OGC-3400](https://linear.app/onegovcloud/issue/OGC-3400) | [a175041156](https://github.com/onegov/onegov-cloud/commit/a1750411569088049fc723101a393e3db2d3645d)

##### Extend emoji ranges in html_to_text plaintext filter

`Feature` | [PRO-1411](https://linear.app/projuventute/issue/PRO-1411) | [5238b18c4c](https://github.com/onegov/onegov-cloud/commit/5238b18c4ca02efb17452e2c09356be58dc6af96)

### Directory

##### Resolve FIXME in handle edit directory

`Feature` | [NONE](#NONE) | [c81f8b0e83](https://github.com/onegov/onegov-cloud/commit/c81f8b0e83980a558ce1a6bf89651389fa078898)

### Event

##### Fixes "event_filter_values violates not-null constraint".

`Bugfix` | [OGC-3403](https://linear.app/onegovcloud/issue/OGC-3403) | [60ce080e28](https://github.com/onegov/onegov-cloud/commit/60ce080e284d5806f7b1223ac4fac9493b7ed45c)

### Events

##### Cli command to translate existing tags after switching to custom tags

`Feature` | [OGC-3114](https://linear.app/onegovcloud/issue/OGC-3114) | [7fa32ce779](https://github.com/onegov/onegov-cloud/commit/7fa32ce7791515ecb0920b6304e28fab2078d8e6)

### Feriennet

##### Add matching tests documenting wish-count neutrality

- wish count itself gives no advantage (equal priority = arbitrary tie-break)
- priority (starring) is the actual lever, not wish count
- a lower-priority wish can never displace a higher-priority one
- the absolute 3-star cap structurally favours low-wish children, who can star their whole wishlist while many-wish children can only cover part

the algorithm does not prefer few-wish children; the perceived effect comes from starring and the non-proportional star cap.

`Feature` | [PRO-1428](https://linear.app/projuventute/issue/PRO-1428) | [3a3b4ffe2d](https://github.com/onegov/onegov-cloud/commit/3a3b4ffe2d20e213ba7546c3b9192036c7c58fa2)

##### Adds test proofing fairness of matching algorithm

`Feature` | [PRO-1428](https://linear.app/projuventute/issue/PRO-1428) | [f702cfcd9b](https://github.com/onegov/onegov-cloud/commit/f702cfcd9be2d66b8a9319635669757dbe1d3a67)

##### Make target group a drop-down for notification templates

`Feature` | [PRO-1562](https://linear.app/projuventute/issue/PRO-1562) | [881c19bf52](https://github.com/onegov/onegov-cloud/commit/881c19bf52d74b6b054e10e4bd70de4f3c194a06)
...
`Bugfix` | [ONEGOV-CLOUD-5FX](https://seantis-gmbh.sentry.io/issues/?query=ONEGOV-CLOUD-5FX) | [bd3716ac1e](https://github.com/onegov/onegov-cloud/commit/bd3716ac1e22076bd392eebabfabf41766de67d3)

### Org

##### Add bulk copy allocation rules.

`Feature` | [OGC-3270](https://linear.app/onegovcloud/issue/OGC-3270) | [0218d431c1](https://github.com/onegov/onegov-cloud/commit/0218d431c1dd423b3bde262b5a15d6c6efe2c3ec)

##### Show page keywords more prominentely.

`Feature` | [OGC-3362](https://linear.app/onegovcloud/issue/OGC-3362) | [461acda642](https://github.com/onegov/onegov-cloud/commit/461acda64264733f6f64f4d5c733b22129af8abb)

##### Displays holidays in find-your-spot results

`Feature` | [OGC-3384](https://linear.app/onegovcloud/issue/OGC-3384) | [0cd99c8dc4](https://github.com/onegov/onegov-cloud/commit/0cd99c8dc48cfca4f5f7053324752de4849fb530)

##### Rename to information architecture and fix view for Safari/Webkit browser

`Feature` | [OGC-3359](https://linear.app/onegovcloud/issue/OGC-3359) | [dac2e5b1b4](https://github.com/onegov/onegov-cloud/commit/dac2e5b1b44b9e28b1d53712ab5be357217462ef)

##### Allows "Kategorie" to be defined in a fieldset in pricing scheme

`Feature` | [OGC-3115](https://linear.app/onegovcloud/issue/OGC-3115) | [a198305026](https://github.com/onegov/onegov-cloud/commit/a198305026441d303082430085430461fc6fb5bc)

##### Add search to settings.

Also creates an explicit setting view registry.

`Feature` | [OGC-3385](https://linear.app/onegovcloud/issue/OGC-3385) | [eaf610e489](https://github.com/onegov/onegov-cloud/commit/eaf610e4899697be0c43e15ba9f2f50e6df6bfff)

##### Resolve template name clash for `/invoices`

Feriennet's invoices.pt isn't the same thing as org/town6's invoices.pt. Two unrelated features independently picked the same generic filename

`Bugfix` | [ONEGOV-CLOUD-5XX](https://seantis-gmbh.sentry.io/issues/?query=ONEGOV-CLOUD-5XX) | [1220ac8a61](https://github.com/onegov/onegov-cloud/commit/1220ac8a610144770f393fe6b98faac1727e0d4e)

##### Fixes crash when editing huge availability periods

This also increases the previously imposed upper limit for availability
period size from two years to five years, since we seem to be able to
just about cope with that amount. Anything larger still seems unwise.

`Bugfix` | [OGC-3412](https://linear.app/onegovcloud/issue/OGC-3412) | [dda23e3591](https://github.com/onegov/onegov-cloud/commit/dda23e35913cc9c9a370745864e539c9e318eae3)

##### Limits availability periods to a maximum duration of two years

Previously this was unlimited and ended up with some customers creating
ranges spanning 5+ years, which made the rules virtually un-editable and
un-deletable.

The limit only applies to the initial range, auto-extending the period
still works indefinitely.

`Performance` | [OGC-3114](https://linear.app/onegovcloud/issue/OGC-3114) | [c4e9bd4d42](https://github.com/onegov/onegov-cloud/commit/c4e9bd4d42c8943aae4b265e7b7f85cfc2198ebf)

### Pas

##### Fixes `changes.pt` appearance.

`Bugfix` | [OGC-3397](https://linear.app/onegovcloud/issue/OGC-3397) | [b42d010378](https://github.com/onegov/onegov-cloud/commit/b42d010378589fedc32cc84356997ac58e45a51c)

### Reservation

##### Allows more than one parent resource per resource

`Feature` | [OGC-3402](https://linear.app/onegovcloud/issue/OGC-3402) | [04cc199a6b](https://github.com/onegov/onegov-cloud/commit/04cc199a6be37fcc1cad6cf9dafdf00d31ea2c36)

##### Fix pricing snapshot migration that zeroed invoices
...
`Bugfix` | [OGC-3406](https://linear.app/onegovcloud/issue/OGC-3406) | [6408ca8401](https://github.com/onegov/onegov-cloud/commit/6408ca8401f7a645645b9ab4f7c4d26022f25ec0)

##### Ensures `orm_cached` blocking resources get flushed

This also fixes a regression in `_blocking_resource_id_mapping`

`Bugfix` | [69c9b3d26e](https://github.com/onegov/onegov-cloud/commit/69c9b3d26e4fa6f84060c7d1b30b85f55ec8c280)

### Search

##### Lower ranking of RIS meeting/meeting item/political business documents in search results

Lowering of parties and politicians is not needed

`Feature` | [OGC-3387](https://linear.app/onegovcloud/issue/OGC-3387) | [a4dc8b832b](https://github.com/onegov/onegov-cloud/commit/a4dc8b832bb7e99a610971b654a2fb0bf58acdaa)

##### Add rank modifier to search index

`Feature` | [NONE](#NONE) | [fc20f30b42](https://github.com/onegov/onegov-cloud/commit/fc20f30b42bb6d76bfafb090d4548e9d1abdfdfd)

### Town6

##### Add/fix missing breadcrumbs

`Feature` | [NONE](#NONE) | [2a68c9b247](https://github.com/onegov/onegov-cloud/commit/2a68c9b24747c5369cde2fccd7a1dfc7eaa90a06)

## 2026.41

`2026-08-14` | [9d645df6d9...78e2baf9d4](https://github.com/OneGov/onegov-cloud/compare/9d645df6d9^...78e2baf9d4)
...
Both activate_schema and limit_session_lifetime fire on every cursor execution, including the internal ROLLBACK TO SAVEPOINT issued by SQLAlchemy's begin_nested() recovery. On a connection already in INERROR state their inner cursor.execute() calls raise InFailedSqlTransaction before the ROLLBACK statement ever reaches PostgreSQL, leaving the connection permanently stuck in INERROR.
...
##### Adds has per directory entry

Each directory entry holds a SHA1 hash of all field values and associated file checksums. The hash is recalculated on every change/update. Also the hash is visible on the api.

`Feature` | [OGC-3096](https://linear.app/onegovcloud/issue/OGC-3096) | [de8bb04d2b](https://github.com/onegov/onegov-cloud/commit/de8bb04d2b69a49f7afd2e83df0358dfc2b2196a)

##### Adds hash per directory entry

Each directory entry holds a SHA-1 hash of all field values and associated file checksums. The hash will be updated on any change to either content or files implemented through an observer.
The hash is visible for managers and mTAN authenticated users. Also the hash is exposed on the API.
...
##### Fix number matching to support prefixed identifiers.
...
##### Adjust booking message text.

`Bugfix` | [512682bfcf](https://github.com/onegov/onegov-cloud/commit/512682bfcf54b7703713adb62eb916d22ee34f3b)

### People

##### Adds capabilities to search for people

`Feature` | [OGC-3228](https://linear.app/onegovcloud/issue/OGC-3228) | [76c67c1f20](https://github.com/onegov/onegov-cloud/commit/76c67c1f202d7c2c2f86de511491cfe29d06b9e0)

### Town6

##### Ensure no edit mode links for sort view

This also aligns agency to town6 in regards to sort views

`Feature` | [OGC-3190](https://linear.app/onegovcloud/issue/OGC-3190) | [a9ee2ea3d5](https://github.com/onegov/onegov-cloud/commit/a9ee2ea3d58d580f9971379ff5e8b1ccc7146f5c)

##### Out-of-range year and invalid status/type params for political business view must not error and must not filter out valid results

`Bugfix` | [HTTPS://SEANTIS-GMBH.SENTRY.IO/ISSUES/7576204851](#HTTPS://SEANTIS-GMBH.SENTRY.IO/ISSUES/7576204851) | [a068aea847](https://github.com/onegov/onegov-cloud/commit/a068aea847fd2941d98771a17977b17d1caccd30)

## 2026.33

`2026-06-19` | [720d0843df...fd7cc2e82a](https://github.com/OneGov/onegov-cloud/compare/720d0843df^...fd7cc2e82a)
...
`2026-06-05` | [cdf0b667e6...8da184cd73](https://github.com/OneGov/onegov-cloud/compare/cdf0b667e6^...8da184cd73)
...
`2026-05-22` | [597bf98ef3...3de3c91a7d](https://github.com/OneGov/onegov-cloud/compare/597bf98ef3^...3de3c91a7d)
...
`2026-05-08` | [d4313d1a42...df0fd2840e](https://github.com/OneGov/onegov-cloud/compare/d4313d1a42^...df0fd2840e)
...
`2026-04-23` | [36245aaa29...ef4ba26201](https://github.com/OneGov/onegov-cloud/compare/36245aaa29^...ef4ba26201)
...
`2026-03-27` | [165b8b17d3...72b3b75960](https://github.com/OneGov/onegov-cloud/compare/165b8b17d3^...72b3b75960)
...
`2026-03-26` | [7cf450189b...14012932b0](https://github.com/OneGov/onegov-cloud/compare/7cf450189b^...14012932b0)
...
`2026-03-18` | [f6448a504b...2ed1e9db67](https://github.com/OneGov/onegov-cloud/compare/f6448a504b^...2ed1e9db67)
...
`2026-03-13` | [7bcfbc7ca6...bcc04abfb1](https://github.com/OneGov/onegov-cloud/compare/7bcfbc7ca6^...bcc04abfb1)
...
`2026-03-09` | [69ffe869b2...6ed90f787e](https://github.com/OneGov/onegov-cloud/compare/69ffe869b2^...6ed90f787e)
...
`2026-02-20` | [0388161dc8...007adfdc2d](https://github.com/OneGov/onegov-cloud/compare/0388161dc8^...007adfdc2d)
...
`2026-02-16` | [0a4012edd8...f7481046ca](https://github.com/OneGov/onegov-cloud/compare/0a4012edd8^...f7481046ca)
